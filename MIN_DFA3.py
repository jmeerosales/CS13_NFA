...
if __name__ == "__main__":
    ...
    print("=" * 65)
    print(f"RUNNING: {dfa1.name}")
    print(f"Language: {dfa1.language}")
    print("=" * 65)
    print(f"Original States  : {dfa1.states}")
    print(f"Minimized States : {min_dfa1.states}")

    accepted_tests = ['0', '11010']
    rejected_tests = ['01', '101']
    ...
    for input_str, expected_type in all_tests:
        orig_acc, orig_st = dfa1.process_string(input_str)
        min_acc, min_st = min_dfa1.process_string(input_str)
